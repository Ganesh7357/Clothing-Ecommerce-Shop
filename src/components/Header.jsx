...
console.log(Helper.UserData,'==================================1234=============')
      // fetchWishlist();
  ...
  return (
    <>
      ...
      <div className="navbar bg-base-100 max-w-7xl mx-auto animate__animated animate__fadeIn">
        ...
        <div className="flex-none">
          ...
          {isLoggedIn && (
            <div className="dropdown dropdown-end">
              <label tabIndex={99} className="btn btn-ghost btn-circle avatar">
      ...
      <div className="navbar-bottom-menu border-y border-gray-800 animate__animated animate__fadeInLeft">
        <div className="drawer">
          ...
          <div className="drawer-side z-10">
            ...
            <FaWindowClose className="text-3xl ml-auto" />
              ...
              {Helper.UserData.isAdmin && (
              <li className="text-xl">
                <NavLink className="text-accent-content" to="/AddProduct">
                  Add Product
                </NavLink>
              </li>
            )}
